...
list_image = ['images/red_fm_radio.png', 'images/radio_city_radio.png',
              'images/abc_news_radio.png', 'images/radio_city_inter_radio.png']
i = 0
...
img_prev = tk.PhotoImage(file='images/radio_prev.png')
...
img_next = tk.PhotoImage(file='images/radio_next.png')
...
img_stop = tk.PhotoImage(file='images/radio_play.png')
