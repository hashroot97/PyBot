...
img_prev = tk.PhotoImage(file="prev.png")
...
img_next = tk.PhotoImage(file="next.png")
...
img_up = tk.PhotoImage(file='up_share_market.png')
img_down = tk.PhotoImage(file='down_share_market.png')
